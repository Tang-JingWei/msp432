...
/*  ？？？？在 system_msp432p401r.c 修改 __SYSTEM_CLOCK 宏为 48000000 才能配置成功 */
...
void SysInit(void)
{
    ...
    CS_setExternalClockSourceFrequency(32768, 48000000);//设置外部晶振LFXT和HFXT的频率值
    ...
    CS_initClockSignal(CS_SMCLK, CS_HFXTCLK_SELECT, CS_CLOCK_DIVIDER_1); //48MHz
}
